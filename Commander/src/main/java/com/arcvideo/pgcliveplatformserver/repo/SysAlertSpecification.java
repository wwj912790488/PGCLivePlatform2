...
/**
 * Created by slw on 2018/6/11.
 */
public class SysAlertSpecification {
    public static Specification<SysAlert> searchByConditions(final Long contentId, final String type, final String level, final ServerType serverType,
