...
public class IpV4Util {
    ...
    public static int tranIntMask2IpV4Value(Integer mask){
        int m = -(1<<(32-mask));
        return m;
    }

    /**
     * @param ipMask 192.168.11.106/24
     * @return 192.168.11.106
     */
    public static String getIPFromIpMask(String ipMask){
     ...
     * @return IpV4Value
     */
    public static Integer getMaskFromIpMask(String ipMask){
        if(!StringUtils.isBlank(ipMask)){
            return tranIntMask2IpV4Value(Integer.valueOf(ipMask.split("/")[1]));
        }
        return null;
    }

    public static void main(String[] args) {
        System.out.println(tranIntMask2IpV4Value(24));
        System.out.println(checkSameSegment("192.168.12.108","192.168.11.106",tranIntMask2IpV4Value(24)));
    }
}
