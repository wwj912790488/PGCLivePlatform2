    ...
    var handleDatatable = function(dataTable, columns, urlList) {
        ...
        $('#create-button').click(function() {
            layer.open({
                ...
                //shade: 0.8,
                area: ['500px', '550px'],
                content: '/material/addIcon' //iframe的url
            });
        });

    };

    handleDatatable($("#material-motion-icon-table"),
        [
            ...
            {"mDataProp": "description","width": "240px"}
        ],
        {"queryUrl": "/material/motionicon/list"}
    );
});