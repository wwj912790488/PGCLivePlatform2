...
function uBindExpand(o) {
	...
	if(o.disabled != null && o.disabled) {
		...
		//unbind "click" first then bind again.
		o.$trigger.unbind("click").click(function() {			
			o.expand = !o.expand;
			if(o.expand) {
				o.$target.show();
			} else {
