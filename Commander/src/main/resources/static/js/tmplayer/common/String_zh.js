...
/* g_string.font_key will be set to transcoder don't translate to English. */
g_string.font_key = {};
g_string.font_key.FangSong = "仿宋";
g_string.font_key.Arial = "Arial";
g_string.font_key.SegoeUI = "Segoe UI";
g_string.font_key.KaiTi = "楷体";
g_string.font_key.SimSun = "宋体";
g_string.font_key.SimHei = "黑体";
g_string.font_key.MSYH = "微软雅黑";
...
str_common.player_only_support_ie32 = "ArcVideo播放器仅支持32位IE浏览器";
...
str_input.filltype_video_black="强制黑帧";
str_input.filltype_audio_silent="强制静音";
str_input.distinguish_audio_video="音视频";
str_input.distinguish_video_only="纯视频";
str_input.distinguish_audio_only="纯音频";
str_input.port_select="端口选择";
str_input.program_match_strict="关闭";//"严格模式";
str_input.program_match_normal="开启";//"普通模式";
...
str_output.danghongyun_s1 = "当虹云1";
str_output.danghongyun = "当虹云";
str_output.udp = "UDP";
str_output.rtp = "RTP";
...
str_output.targetName = "{0}_{1}_{2}";
...
str_output.distribute_webdav="发布到WebDAV";
str_output.hls_reserve_segment="保留切片";
str_output.hls_delete_expired="删除过期切片";
str_output.hls_vod_mode="点播切片";
str_output.self_generated="自动生成";
str_output.verimatrix="Verimatrix";
str_output.irdeto="Irdeto";
str_output.yongxin="永新";
str_output.timecode_mode0="跟随源";
str_output.timecode_mode1="关闭";
...
str_warning.get_image_size_failed="获取图片宽高失败";
...
str_video.frame_rate_source="跟随源（源帧率可能不准，建议固定帧率！）";
...
str_video.fast="性能最优（推荐）";
str_video.faster="较快";
str_video.balance="性能平衡";
str_video.high_quality="高质量";
str_video.best_quality="性能占用最多";
str_video.mostbest_quality="最高质量模式";
str_video.mostbestplus_quality="最高质量模式+";
str_video.gop_type_frame="帧";
str_video.gop_type_ms="毫秒";
str_video.pass_through ="透传";
str_video.color_primaries_BT709="BT709";
str_video.color_primaries_BT2020="BT2020";
str_video.color_primaries_BT601="BT601";
str_video.luminance_range_SDR="SDR";
str_video.luminance_range_HLG="HLG";
str_video.luminance_range_HDR10="HDR10";
str_video.luminance_range_PQ="PQ";
...
str_motion_icon.always="全时段";
str_motion_icon.customized="自定义";
str_motion_icon.film_title="片头";
str_motion_icon.film_ending="片尾";
...
str_dynamic_text.border_thickness_0 = "无";
str_dynamic_text.border_thickness_1 = "非常细";
str_dynamic_text.border_thickness_2 = "很细";
str_dynamic_text.border_thickness_3 = "细";
str_dynamic_text.border_thickness_4 = "中等";
str_dynamic_text.border_thickness_5 = "粗";
str_dynamic_text.border_thickness_6 = "非常粗";
